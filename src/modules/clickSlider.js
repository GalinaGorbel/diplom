...
const clickSlider = ({ main, wraper, position = 0, slidesToShow, infinity = false }) => {
    ...
    function addArrow(direction, imgArrow) {
        ...
        mainSlider.insertAdjacentHTML('beforeend', `<a href="#" class="slider-arrow ${direction}"><span data-arrow="${direction}"><img src='${imgArrow}' data-arrow="${direction}"><img></span></a>`);
    }
